...
(function () {
    ...
    var upoadedBox = function upoadedBox(columnKeys) {
      // <div class=\"uploaded-item-preview\">\n{{#" + columnKeys.thumbnail + "}}<img src=\"" + columnKeys.apiServerUrl + "{{" + columnKeys.thumbnail + "}}\">{{/" + columnKeys.thumbnail + "}}\n</div>\n
        return "\n{{#uploadedFiles}}<li data-ax5uploader-uploaded-item=\"{{@i}}\">\n    <div class=\"uploaded-item-holder\">\n <a class=\"uploaded-item-cell file_del\" data-uploaded-item-cell=\"delete\" title=\"삭제\">{{{icon.delete}}}</a>\n <span class=\"uploaded-item-cell\"data-uploaded-item-cell=\"download\">{{{icon.download}}}</span> \n <i class=\"ico_ext ext_{{" + columnKeys.type + "}}\"></i>\n <span class=\"uploaded-item-cell\" data-uploaded-item-cell=\"filename\">{{" + columnKeys.name + "}}</span>\n<span class=\"uploaded-item-cell file_size\" data-uploaded-item-cell=\"filesize\">{{#@fn_get_byte}}{{" + columnKeys.size + "}}{{/@fn_get_byte}}</span>\n</div> \n</li>{{/uploadedFiles}}\n{{^uploadedFiles}}\n{{#supportFileApi}}{{{lang.supportedHTML5_emptyListMsg}}}{{/supportFileApi}}\n{{^supportFileApi}}{{{lang.emptyListMsg}}}{{/supportFileApi}}\n{{/uploadedFiles}}\n";
    };
